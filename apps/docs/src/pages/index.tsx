      ...
      components: [
        {
          ...
          desc: "Panel de control para cada empresa",
        },
      ...
      <div className="max-w-full mx-auto">
              ...
              <div className="bg-slate-700 p-4 rounded-lg">
                ...
                <div className="space-y-2 font-mono text-sm">
                  {[
                    ...
                    <div
                      key={i}
                      className="bg-slate-800 p-3 rounded flex items-start gap-3"
                    >
                      <span
              ...
              <ul className="space-y-2 text-slate-300">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    <code className="text-yellow-400">companyId</code> para
                    aislamiento
                  </span>
                </li>
                <li className="flex items-start gap-2">
        ...
        <div className="mt-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-6 text-white">
          ...
          <ol className="space-y-2 text-sm">
            <li>
              <strong>1.</strong> Empresa se registra y crea cuenta
            </li>
            <li>
              <strong>2.</strong> Crea un bot y escanea código QR
            </li>
            <li>
              <strong>3.</strong> Backend crea instancia de whatsapp-web.js
            </li>
            <li>
              <strong>4.</strong> Configura flujos conversacionales
            </li>
            <li>
              <strong>5.</strong> Cuando llega mensaje, Flow Engine procesa y
              responde
            </li>
            <li>
              <strong>6.</strong> Frontend recibe actualizaciones vía WebSocket
            </li>
            <li>
              <strong>7.</strong> Se guardan métricas y conversaciones en
              MongoDB
            </li>
          </ol>
        </div>
